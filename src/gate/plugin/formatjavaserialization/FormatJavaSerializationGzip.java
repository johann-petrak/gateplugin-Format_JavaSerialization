...
@CreoleResource(
        ...
        comment = "Support for reading documents serialized as GZIP-compressed Java objects", 
        helpURL = "")
public class FormatJavaSerializationGzip extends DocumentFormat  {

  //private static final long serialVersionUID = -2394353168913311584L;
  
  /** Default construction */
  public FormatJavaSerializationGzip() {
    super();
  }
  ...
  public Resource init() throws ResourceInstantiationException {
    System.err.println("Running init of FormatJavaSerializationGzip");
  ...
  public void unpackMarkup(Document dcmnt) throws DocumentFormatException {
    ...
    try (
            ...
            ObjectInputStream oistream =
                    new ObjectInputStream(new GZIPInputStream(urlStream));
            ) {
