...
@CreoleResource(
        ...
        comment = "Support for reading documents serialized as Snappy-compressed Java objects", 
        helpURL = "")
public class FormatJavaSerializationSnappy extends DocumentFormat  {

  //private static final long serialVersionUID = -2394353168913311584L;
  
  /** Default construction */
  public FormatJavaSerializationSnappy() {
    super();
  }
  ...
  public void unpackMarkup(Document dcmnt) throws DocumentFormatException {
    ...
    try (
            ...
            ObjectInputStream oistream =
                    new ObjectInputStream(new SnappyInputStream(urlStream));
            ) {
