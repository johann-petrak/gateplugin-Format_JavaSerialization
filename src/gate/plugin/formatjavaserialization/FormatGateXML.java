...
@CreoleResource(
        name = "GATE XML format",
        isPrivate = true,
        autoinstances = {
          @AutoInstance(hidden = true)},
        comment = "Support for reading GATE documents in XML format",
        helpURL = "")
public class FormatGateXML extends XmlDocumentFormat {

  //private static final long serialVersionUID = -2394353168913311584L;
  /**
   * Default construction
   */
  public FormatGateXML() {
    super();
  }
  ...
  public Resource init() throws ResourceInstantiationException {
    MimeType mime = new MimeType("text", "gatexml");
    mimeString2ClassHandlerMap.put(mime.getType() + "/" + mime.getSubtype(), this);
    mimeString2mimeTypeMap.put(mime.getType() + "/" + mime.getSubtype(), mime);
    mimeString2mimeTypeMap.put("application/xml+gate", mime);
    suffixes2mimeTypeMap.put("gatexml", mime);
    setMimeType(mime);
    return this;
  }
  ...
  protected void unpackMarkupHelper(Document dcmnt)
    ...
    try (
            ...
            InputStreamReader inputReader = new InputStreamReader(urlStream, encoding);) {
